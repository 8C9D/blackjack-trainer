...
/// How far a wrong count landed from the real one, in the same words the table's
...
/// The two modes whose feedback is a paragraph rather than a table, kept out of
/// the main body so the view's own layout stays legible.
extension CountFeedbackView {
    @ViewBuilder
